...
-- add crops to mapgen
register_plant("potato_3", 1, 80, nil, "", -1, farming.potato)
register_plant("tomato_7", 5, 40, nil, "", -1, farming.tomato)
register_plant("corn_7", 1, 42, nil, "", -1, farming.corn)
register_plant("raspberry_4", 3, 20, nil, "", -1, farming.raspberry)
register_plant("rhubarb_3", 3, 25, nil, "", -1, farming.rhubarb)
register_plant("blueberry_4", 3, 20, nil, "", -1, farming.blueberry)
register_plant("beanbush", 1, 65, nil, "", -1, farming.beans)
register_plant("grapebush", 2, 85, nil, "", -1, farming.grapes)
register_plant("onion_5", 5, 42, nil, "", -1, farming.onion)
register_plant("garlic_5", 3, 60, nil, "group:tree", 1, farming.garlic)
register_plant("pea_5", 5, 100, nil, "", -1, farming.peas)
register_plant("beetroot_5", 1, 25, nil, "", -1, farming.beetroot)
register_plant("cabbage_6", 2, 20, nil, "", -1, farming.cabbage)
register_plant("lettuce_5", 5, 60, nil, "", -1, farming.lettuce)
register_plant("blackberry_4", 3, 20, nil, "", -1, farming.blackberry)
register_plant("vanilla_7", 5, 65, nil, "", -1, farming.vanilla)
register_plant("parsley_3", 1, 80, nil, "", -1, farming.parsley)
register_plant("sunflower_8", 1, 80, nil, "", -1, farming.sunflower)
register_plant("mint_4", 1, 145, {
...
if mg_name == "v6" then
	...
	register_plant("carrot_8", 1, 60, nil, "group:water", 1, farming.carrot)
	register_plant("cucumber_4", 1, 40, nil, "group:water", 1, farming.cucumber)
	register_plant("melon_8", 1, 40, nil, "group:water", 1, farming.melon)
	register_plant("pumpkin_8", 1, 40, nil, "group:water", 1, farming.pumpkin)
	register_plant("coffee_5", 10, 85, nil, "", -1, farming.coffee)
	register_plant("soy_6", 10, 100, nil, "", -1, farming.soy)
else
	-- v7 maps have a beach so plants growing near water is limited to 6 high
	register_plant("carrot_8", 1, 25, nil, "", -1, farming.carrot)
	register_plant("cucumber_4", 1, 20, nil, "", -1, farming.cucumber)
	register_plant("melon_8", 1, 12, {"default:dirt_with_dry_grass",
		"default:dirt_with_rainforest_litter"}, "", -1, farming.melon)
	register_plant("pumpkin_8", 1, 12, nil, "", -1, farming.pumpkin)
	register_plant("coffee_5", 10, 85, {"default:dirt_with_dry_grass",
		"default:dirt_with_rainforest_litter",
		"default:dry_dirt_with_dry_grass"}, "", -1, farming.coffee)
	register_plant("soy_6", 10, 100, {"default:dirt_with_dry_grass",
		"default:dirt_with_rainforest_litter",
